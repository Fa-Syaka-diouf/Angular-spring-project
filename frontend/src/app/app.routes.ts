...
export const routes: Routes = [
  ...
  { path: 'pharmacie', loadComponent: () => import('./pharmacie/pharmacie.component').then(m => m.PharmacieComponent) },
  ...
  { path: 'details-medicament', component: MedicamentDetailComponent },
